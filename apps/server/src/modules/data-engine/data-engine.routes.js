...
//
// ⚠️ CONFIDENTIEL — Propriété exclusive de VECTRYS SAS.
// Ces routes, données et résultats d'analyse ne doivent JAMAIS
// être exposés publiquement ni partagés avec des tiers.
//
...
import { classifyDataAsset, getValorizationRecommendations } from './classification/classifier.service.js';
import { runAnonymizationPipeline } from './anonymization/pipeline.service.js';
import { calculateDynamicPrice, createStripeSubscription } from './pricing/pricing.service.js';
import { clusterAssets, generateInsightsReport } from './analytics/analytics.service.js';
import { requirePermission, sensitiveRateLimiter } from './guards/internal-only.guard.js';
